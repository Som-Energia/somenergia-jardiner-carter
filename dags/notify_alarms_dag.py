...
from jardiner_carter_tasks.t_image_build import build_image_build_task
from jardiner_carter_tasks.t_remove_image import build_remove_image_task
...
with DAG(dag_id='jardiner_carter_dag', start_date=datetime(2022,9,26), schedule_interval='@hourly', catchup=False, tags=["Plantmonitor", "Jardiner"], default_args=args) as dag:
    ...
    notify_alarms_task = DockerOperator(
        api_version='auto',
        task_id='jardiner_carter_notify',
        image='somenergia-jardiner-carter-requirements:latest',
        working_dir='/repos/somenergia-jardiner-carter',
